...
import type { UserProfile, UserProgress, InstrumentType } from '@/types/user';
...
export default function Dashboard() {
 ...
 useEffect(() => {
   ...
   if (currentUserId) {
     ...
     const userProgress = UserService.getUserProgress(currentUserId);

     if (userProfile && userProfile.instrument) {
       setUserData(userProfile as UserProfile);
     } else {
       setUserData(null);
     }
     ...
     setStreak(diffDays <= 1 ? (userProgress?.streak || 0) : 0);
   }
 }, []);
